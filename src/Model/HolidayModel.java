...
public class HolidayModel {
    ...
    public boolean addHoliday(int id, int id_employe, Date startdate, Date enddate, HolidayType type , Employe targetEmploye) {
    ...
    public boolean updateHoliday(int id, int id_employe, Date startdate, Date enddate, HolidayType type , Employe targetEmploye , int olddaysbetween ) {
